...
var cpf_1 = __importDefault(require("../modelos/cpf"));
...
var CadastroCliente = /** @class */ (function (_super) {
    ...
    CadastroCliente.prototype.cadastrar = function () {
        ...
        var nomeSocial = this.entrada.receberTexto("Por favor informe o nome social: ");
        var sexo = this.entrada.receberTexto('por favor, digite seu sexo[F/M]: ');
        var valor = this.entrada.receberTexto("Por favor informe o  cpf: ");
        ...
        var cliente = new cliente_1.default(nome, nomeSocial, sexo.toUpperCase(), cpf);
